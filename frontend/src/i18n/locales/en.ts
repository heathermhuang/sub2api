  ...
  admin: {
    ...
    groups: {
      ...
      mediaPricing: {
        ...
        description: 'Configure Grok image and video generation access plus base media prices. Leave empty to use default prices.',
        ...
        modeHint: 'By default, Grok media billing uses media price × current effective group multiplier. Independent mode uses media price × media multiplier. One video generation is billed as one media unit.',
