export default {
  ...
  customDomains: {
    ...
    verified: 'Domain verified',
	    ...
	    sharedStatusDescription: 'Setup is managed by the domain owner or an administrator.',
	    sharedNextAction: 'Wait for the domain owner or an administrator to finish verification. Once active, use the API Base URL shown here.',
