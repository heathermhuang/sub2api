  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        nativeInstallTitle: 'Install into Codex safely',
        nativeInstallDescription: 'Open Codex Web GPT to merge this Responses route into the existing Codex configuration. The launcher journals the current route and auth files, clears the model cache, and restores them on disconnect.',
        nativeInstallAction: 'Open Codex Web GPT',
        copyKeyForInstaller: 'Copy key for installer',
        nativeInstallProviderName: 'Sub2API Responses bridge',
        nativeInstallAllowance: 'ChatGPT Web allowance is used through unofficial browser automation; it is not converted into OpenAI API credit.',
        nativeInstallTools: 'This installs the provider and model catalog only. Local computer tools still require the Full MCP harness in Codex Web GPT.',
